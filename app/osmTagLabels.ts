...
export const tagNameCorrespondance = (key: string) => {
	const found = {
		...
		'defibrillator:location': 'Emplacement',
		...
		'socket:tesla_supercharger:output':
			'Puissance de la prise Tesla Supercharger',
		'socket:tesla_supercharger:current':
			'Courant de la prise Tesla Supercharger',
		'socket:tesla_supercharger:voltage':
			'Voltage de la prise Tesla Supercharger',
		'socket:tesla_supercharger_ccs': 'Nombre de prise Tesla Supercharger CCS',
		'socket:tesla_supercharger_ccs:output':
			'Puissance de la prise Tesla Supercharger CCS',
		'socket:tesla_supercharger_ccs:current':
			'Courant de la prise Tesla Supercharger CCS',
		'socket:tesla_supercharger_ccs:voltage':
			'Voltage de la prise Tesla Supercharger CCS',
