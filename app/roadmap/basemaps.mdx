...
OpenStreetMap is rich, sometimes incredibly rich. In most cases, especially in cities, you don't want to show _all_ of OSM's data to your users to avoid drowning key information in details. If the style serves as the ultimate filter, the whole point of tiles design is to carefully select some features (places, trees, shops, trash bins...) for some level of zooms only, in order to save bandwidth space.
