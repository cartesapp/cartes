		...
		/* Not sure we need a path outline, hence deactivated for now
	{
		...
		},
		{
			...
			paint: {
				...
				'text-halo-blur': 1,
				'text-halo-color': dark ? 'hsla(0,0%,100%,0.2)' : 'hsl(0,0%,100%)',
				'text-halo-width': dark ? 0.5 : 1,
			},
			metadata: {},
		...
		},
		{
			...
			paint: {
				'text-color': !dark ? 'hsl(0,0%,15%)' : 'hsl(0,0%,100%)',
				'icon-opacity': 1,
				'text-opacity': [
					'step',
					['zoom'],
				...
				'text-halo-color': dark ? 'hsla(0,0%,10%)' : 'hsl(0,0%,100%)',
				'text-halo-width': dark ? 0.6 : 1.2,
			},
			metadata: {},
			filter: [
				'all',
