...
Mobile / Desktop. Lots of work here. Place pages. We can go far, we've done some barebone stuff.

### Internationalisation

Cartes is build in France, in French. We wanted to check the interest before thinking global. We'll think European, now that the US let us. We'll keep French as a main language, now that no country in the European union natively speak english anymore.

Ce que j'ai mis dans le mail mais sous forme d'issues.
